					...
					<tbody>
						<tr>
							<td><label for="title">제목</label><input type="text"
								id="title" class="chk" title="pl title" name="title"
								value="${update.title}" /></td>
						</tr>
						<tr>
							<td><label for="content">내용</label>
							<textarea id="content" class="chk" title="pl content"
									name="content"><c:out value="${update.content}" /></textarea>
							</td>
						</tr>
						<tr>
							<td><label for="writer">작성자</label><input type="text"
								id="writer" name="writer" class="chk" title="pl writer"
